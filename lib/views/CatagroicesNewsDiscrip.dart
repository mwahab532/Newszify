...
class Catagroicesnewsdiscrip extends StatelessWidget {
  final Article articles;
  const Catagroicesnewsdiscrip({Key? key, required this.articles})
      : super(key: key);
                  ...
                  onPressed: () {
                    if (articles.url != null) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                            content:
                                Text("URL not available for this article.")),
                      );
                    }
                  },
                ),
